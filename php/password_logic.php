...
if (isset($_POST['reset-password'])) {
  ...
  if (count($errors) == 0) {
	...
	try {
		...
		$mail->Body    = "Hi there, click on this link to reset your password on our site. http://127.0.0.1/cs26/php/reset_password.php?token=$token";
		$mail->send();
...
if (isset($_POST['new_password'])) {
    ...
    if ($email) {
		...
		header("location: http://127.0.0.1/cs26/reset_password.html?token=$token");
	}
  }
}
?>